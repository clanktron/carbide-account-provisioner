<template>
  <input
    ...
    placeholder="Search for an account by name..."
      ...
      <tr v-for="robot in robots" :key="robot.id">
        ...
        <td>
          <button
            ...
            class="btn btn-primary"
            data-bs-toggle="modal"
            :data-bs-target="'#editModal-' + robot.id"
          >
            Edit
          </button>
  ...
  <div class="d-flex justify-content-center gap-3">
    <button class="btn btn-primary" :disabled="onFirstPage" @click="currentPage--">Previous</button>
    <button
    ...
    <button class="btn btn-primary" :disabled="onLastPage" @click="currentPage++">Next</button>
  </div>
